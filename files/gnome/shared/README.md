...
It owns GNOME-specific session behavior, GNOME portal selection, GNOME-only helpers, and the family marker at `usr/share/current/workstation/desktop.env` consumed by the shared workstation display-manager helper.
