...
- `fedora/nvidia-580-workstation.yml`: Fedora R580 workstation-only userspace extras; it temporarily restores the Negativo17 R580 repo after the base R580 layer removes it, then removes the repo again.
