...
- shared admin/operator overlay behavior belongs in `recipes/layers/shared/admin-overlay.yml`, which is included by the shared core contract for every image
